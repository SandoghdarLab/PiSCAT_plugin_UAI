...
class BinaryToiSCATLocalization:
    ...
    def __init__(self, video_binary, video_iSCAT, DNN_Residual=None, df_postion=None, sigma=1.7, area_threshold=4, internal_parallel_flag=True):
        """
        ...
        self.DNN_Residual = DNN_Residual
    ...
    def _kernel_area_closing(self, f_, area_threshold=4):
        return area_closing(self.video_binary[f_], area_threshold=area_threshold, connectivity=2)
